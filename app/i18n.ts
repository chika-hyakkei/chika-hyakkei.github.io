...
const japanese = {
  ...
  "job.sage.skill2": "雷撃",
  "job.samurai.name": "侍",
  "job.samurai.desc": "50階を越えた者の一撃必殺",
  "job.samurai.skill1": "居合斬り",
  "job.samurai.skill2": "見切り",
  "job.alchemist.name": "錬金術師",
  "job.alchemist.desc": "80階を越えた者の道具錬成",
  "job.alchemist.skill1": "爆薬調合",
  "job.alchemist.skill2": "再生調合",
  "battle.attack": "たたかう",
  "battle.guard": "防御",
  "battle.potion": "回復薬",
  "battle.bomb": "爆裂石",
...
const english: Partial<Record<TranslationKey, string>> = {
  ...
  "job.samurai.name": "Samurai",
  "job.samurai.desc": "A decisive blade unlocked past floor 50",
  "job.samurai.skill1": "Iaijutsu",
  "job.samurai.skill2": "Read the Strike",
  "job.alchemist.name": "Alchemist",
  "job.alchemist.desc": "A tool-making class unlocked past floor 80",
  "job.alchemist.skill1": "Blast Synthesis",
  "job.alchemist.skill2": "Regeneration Mix",
