...
function rate(forecast){let wins=0,total=0;for(const job of jobs)for(let seed=1;seed<=10000;seed++){wins+=campaign(seed*7919,job,forecast)?1:0;total++;}return wins/total}
